...
class KeyValueStoreServicer:
    """KeyValueStore — in-memory
     хранилище ключ–значение с TTL и LRU eviction.
    Контракт менять нельзя. Реализуйте серверную часть.
    """

    def Put(self, request, context):
        """Put: добавить или обновить значение.
        ttl_seconds = 0 означает отсутствие TTL."""
    ...
    def Get(self, request, context):
        ...
        NOT_FOUND — если ключ отсутствует или TTL истёк."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def List(self, request, context):
        """List: вернуть все ключи и значения с данным prefix.
        Истёкшие по TTL не возвращать."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
